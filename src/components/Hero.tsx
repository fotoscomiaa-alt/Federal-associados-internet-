    ...
    <section className="hero">
      ...
      <div className="container heroGrid">
        <div className="heroCopy">
          <div className="eyebrow">CONECTIVIDADE <span>•</span>  <span>•</span> BENEFÍCIOS</div>
          <h1>Conexão e benefícios <em>para sua rotina.</em></h1>
          <p className="heroText">Soluções de conectividade,benefícios pensados para você e sua família.</p>
          <div className="heroFeatureRow" aria-label="Destaques da Federal Associados">
            <span><b>⌁</b> Internet de qualidade</span>
            <span><b>◌</b> Atendimento de qualidade</span>
